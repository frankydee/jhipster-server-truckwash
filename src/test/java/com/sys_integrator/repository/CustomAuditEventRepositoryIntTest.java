...
import com.sys_integrator.config.audit.AuditEventConverter;
import com.sys_integrator.domain.PersistentAuditEvent;
...
import static com.sys_integrator.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
