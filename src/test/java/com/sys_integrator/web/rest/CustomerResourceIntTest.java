...
import com.sys_integrator.domain.Customer;
import com.sys_integrator.repository.CustomerRepository;
...
public class CustomerResourceIntTest {
    ...
    private static final Language DEFAULT_PREFERRED_LANGUAGE = Language.EN;
    private static final Language UPDATED_PREFERRED_LANGUAGE = Language.SV;
    ...
    private static final LoggingLevel UPDATED_LOGGING_LEVEL = LoggingLevel.WARNING;
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getPreferredLanguage()).isEqualTo(DEFAULT_PREFERRED_LANGUAGE);
        assertThat(testCustomer.getActive()).isEqualTo(DEFAULT_ACTIVE);
        assertThat(testCustomer.getLoggingLevel()).isEqualTo(DEFAULT_LOGGING_LEVEL);
    }
    ...
    @Test
    @Transactional
    public void checkPreferredLanguageIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setPreferredLanguage(null);
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].loggingLevel").value(hasItem(DEFAULT_LOGGING_LEVEL.toString())));
    }
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.loggingLevel").value(DEFAULT_LOGGING_LEVEL.toString()));
    }
    ...
    public void updateCustomer() throws Exception {
        ...
        updatedCustomer
            ...
            .loggingLevel(UPDATED_LOGGING_LEVEL);
        ...
        assertThat(testCustomer.getPreferredLanguage()).isEqualTo(UPDATED_PREFERRED_LANGUAGE);
        assertThat(testCustomer.getActive()).isEqualTo(UPDATED_ACTIVE);
        assertThat(testCustomer.getLoggingLevel()).isEqualTo(UPDATED_LOGGING_LEVEL);
    }
